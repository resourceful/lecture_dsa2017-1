...
\begin{frame}[t]
  ...
  \begin{itemize}
  \item Euler used graph to solve the Koenigsberg bridge problem in 1736
...
\begin{frame}[t]
  ...
  \item $E$ is the edge set. Ex. $E= \{(0,1), (1,3), (2,3), (0, 2)\}$
    ...
    \item Edges are also called acrs and lines
    \end{itemize}
...
\begin{frame}[t]
  ...
  \item Directed Edge has an \textit{Orientation} $(u, v)$
    \begin{itemize}
    \item Directed graph = Every Edge has an orientation
    \end{itemize}
  \end{itemize}
  \begin{center}
    \begin{tikzpicture}
...
\begin{frame}[t]
  ...
  \begin{itemize}
  \item \textbf{Vertex Degree} is the number of edges of the vertex
...
\begin{frame}[t]
  ...
  \item  If $G$ is undirected graph and $(u,v)$ is an edge of $G$, then
    ...
    \item $(u,v)$ is \textbf{incident} on vertices $u$ and $v$
    \end{itemize}
...
\begin{frame}[t]
  \frametitle{Propertiex of Adjacency Matrix}
  \begin{itemize}
